                            ...
                            <div class="col-xl-11">
                                ...
                                <div class="page-header pr-0 pl-0">
                                    <div class="d-flex align-items-center">
                                        <h2 class="page-header-title">Groups</h2>
                                        <div>
                                        <div class="page-header-tools">
                                            <a class="btn btn-gradient-01" href="#">Create Group</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="widget-image has-shadow">
                                            <div class="group-card">
                                                ...
                                                <div class="widget-body">
                                                    ...
                                                    <div class="cover-image mx-auto">
                                                        <img src="assets/img/group/02.jpg" alt="..." class="rounded-circle mx-auto">
                                                    </div>
                                                    <h4 class="name"><a href="#">Lorem Club</a></h4>
                                                    <div class="category">Lifestyle</div>
                                                    <div class="stats text-center">
                                                        <span><i class="la la-users"></i></span>
                                                        <span class="counter">2,471</span> 
                                                        <span class="text">Members</span>
                                                    </div>
                                                    <div class="group-members text-center mt-4">
                                                        <a href="javascript:void(0);">
                                        ...
                                        <div class="widget-image has-shadow">
                                            <div class="group-card">
                                                ...
                                                <div class="widget-body">
                                                    ...
                                                    <div class="cover-image mx-auto">
                                                        <img src="assets/img/group/03.jpg" alt="..." class="rounded-circle mx-auto">
                                                    </div>
                                                    <h4 class="name"><a href="#">ABC Fitness</a></h4>
                                        ...
                                        <div class="widget-image has-shadow">
                                            <div class="group-card">
                                                ...
                                                <div class="widget-body">
                                                    ...
                                                    <div class="cover-image mx-auto">
                                                        <img src="assets/img/group/04.jpg" alt="..." class="rounded-circle mx-auto">
                                                    </div>
                                                    <h4 class="name"><a href="#">Global DJ</a></h4>
                                                    <div class="category">Music</div>
                                                    <div class="stats text-center">
                                                        <span><i class="la la-users"></i></span>
                                                        <span class="counter">4,500</span> 
                                                        <span class="text">Members</span>
                                                    </div>
                                                    <div class="group-members text-center mt-4">
                                                        <a href="javascript:void(0);">
                                                            <img src="assets/img/avatar/avatar-08.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="javascript:void(0);">
                                                            <img src="assets/img/avatar/avatar-06.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                        ...
                                        <div class="widget-image has-shadow">
                                            <div class="group-card">
                                                ...
                                                <div class="widget-body">
                                                    ...
                                                    <div class="cover-image mx-auto">
                                                        <img src="assets/img/group/05.jpg" alt="..." class="rounded-circle mx-auto">
                                                    </div>
                                                    <h4 class="name"><a href="#">Guitar Lover</a></h4>
                                                    <div class="category">Music</div>
                                                    <div class="stats text-center">
                                                        <span><i class="la la-users"></i></span>
                                                        <span class="counter">3,853</span> 
                                                        <span class="text">Members</span>
                                                    </div>
                                                    <div class="group-members text-center mt-4">
                                                        <a href="javascript:void(0);">
                                        ...
                                        <div class="widget-image has-shadow">
                                            <div class="group-card">
                                                ...
                                                <div class="widget-body">
                                                    ...
                                                    <div class="cover-image mx-auto">
                                                        <img src="assets/img/group/06.jpg" alt="..." class="rounded-circle mx-auto">
                                                    </div>
                                                    <h4 class="name"><a href="#">PS4 Fan</a></h4>
                                                    <div class="category">Video Games</div>
                                                    <div class="stats text-center">
                                                        <span><i class="la la-users"></i></span>
                                                        <span class="counter">5,357</span> 
                                                        <span class="text">Members</span>
                                                    </div>
                                                    <div class="group-members text-center mt-4">
                                                        <a href="javascript:void(0);">
