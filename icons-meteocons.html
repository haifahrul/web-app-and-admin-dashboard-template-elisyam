...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Icons Metecons</title>
                ...
                <div class="default-sidebar">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="#dropdown-icons" aria-expanded="true" data-toggle="collapse"><i class="la la-font"></i><span>Icons</span></a>
                                <ul id="dropdown-icons" class="collapse list-unstyled show pt-0">
                                    <li><a href="icons-lineawesome.html">Line Awesome</a></li>
                                    <li><a href="icons-themify.html">Themify</a></li>
                                    <li><a href="icons-ionicons.html">Ionicons</a></li>
                                    <li><a class="active" href="icons-meteocons.html">Meteocons</a></li>
                                </ul>
                            </li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Meteocons</h2>
	                                <div>
			                            <ul class="breadcrumb">
			                                <li class="breadcrumb-item"><a href="db-default.html"><i class="ti ti-home"></i></a></li>
			                                <li class="breadcrumb-item"><a href="#">Icons</a></li>
			                                <li class="breadcrumb-item active">Meteocons</li>
			                            </ul>
	                                </div>
	                            </div>
                            </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="row">
                                            <div class="col-md-2">
                                                ...
                                                <div class="c-class">meteocons-sunrise</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-sun"></i>
                                                </div>
                                                <div class="c-class">meteocons-sun</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-moon"></i>
                                                </div>
                                                <div class="c-class">meteocons-moon</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-sun2"></i>
                                                </div>
                                                <div class="c-class">meteocons-sun2</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-windy"></i>
                                                </div>
                                                <div class="c-class">meteocons-windy</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-snowflake"></i>
                                                </div>
                                                <div class="c-class">meteocons-snowflake</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-cloudy"></i>
                                                </div>
                                                <div class="c-class">meteocons-cloudy</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-cloud"></i>
                                                </div>
                                                <div class="c-class">meteocons-cloud</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-weather"></i>
                                                </div>
                                                <div class="c-class">meteocons-weather</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-weather2"></i>
                                                </div>
                                                <div class="c-class">meteocons-weather2</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-weather3"></i>
                                                </div>
                                                <div class="c-class">meteocons-weather3</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-lines"></i>
                                                </div>
                                                <div class="c-class">meteocons-lines</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-cloud2"></i>
                                                </div>
                                                <div class="c-class">meteocons-cloud2</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-lightning"></i>
                                                </div>
                                                <div class="c-class">meteocons-lightning</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-lightning2"></i>
                                                </div>
                                                <div class="c-class">meteocons-lightning2</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-rainy"></i>
                                                </div>
                                                <div class="c-class">meteocons-rainy</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-rainy2"></i>
                                                </div>
                                                <div class="c-class">meteocons-rainy2</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-windy2"></i>
                                                </div>
                                                <div class="c-class">meteocons-windy2</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-windy3"></i>
                                                </div>
                                                <div class="c-class">meteocons-windy3</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-snowy"></i>
                                                </div>
                                                <div class="c-class">meteocons-snowy</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-snowy2"></i>
                                                </div>
                                                <div class="c-class">meteocons-snowy2</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-snowy3"></i>
                                                </div>
                                                <div class="c-class">meteocons-snowy3</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-weather4"></i>
                                                </div>
                                                <div class="c-class">meteocons-weather4</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-cloudy2"></i>
                                                </div>
                                                <div class="c-class">meteocons-cloudy2</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-cloud3"></i>
                                                </div>
                                                <div class="c-class">meteocons-cloud3</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-lightning3"></i>
                                                </div>
                                                <div class="c-class">meteocons-lightning3</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-sun3"></i>
                                                </div>
                                                <div class="c-class">meteocons-sun3</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-moon2"></i>
                                                </div>
                                                <div class="c-class">meteocons-moon2</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-cloudy3"></i>
                                                </div>
                                                <div class="c-class">meteocons-cloudy3</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-cloud4"></i>
                                                </div>
                                                <div class="c-class">meteocons-cloud4</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-cloud5"></i>
                                                </div>
                                                <div class="c-class">meteocons-cloud5</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-lightning4"></i>
                                                </div>
                                                <div class="c-class">meteocons-lightning4</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-rainy3"></i>
                                                </div>
                                                <div class="c-class">meteocons-rainy3</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-rainy4"></i>
                                                </div>
                                                <div class="c-class">meteocons-rainy4</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-windy4"></i>
                                                </div>
                                                <div class="c-class">meteocons-windy4</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-windy5"></i>
                                                </div>
                                                <div class="c-class">meteocons-windy5</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-snowy4"></i>
                                                </div>
                                                <div class="c-class">meteocons-snowy4</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-snowy5"></i>
                                                </div>
                                                <div class="c-class">meteocons-snowy5</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-weather5"></i>
                                                </div>
                                                <div class="c-class">meteocons-weather5</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-cloudy4"></i>
                                                </div>
                                                <div class="c-class">meteocons-cloudy4</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-lightning5"></i>
                                                </div>
                                                <div class="c-class">meteocons-lightning5</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-thermometer"></i>
                                                </div>
                                                <div class="c-class">meteocons-thermometer</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-compass"></i>
                                                </div>
                                                <div class="c-class">meteocons-compass</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-none"></i>
                                                </div>
                                                <div class="c-class">meteocons-none</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-Celsius"></i>
                                                </div>
                                                <div class="c-class">meteocons-Celsius</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="c-icon">
                                                    <i class="meteocons-Fahrenheit"></i>
                                                </div>
                                                <div class="c-class">meteocons-Fahrenheit</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
