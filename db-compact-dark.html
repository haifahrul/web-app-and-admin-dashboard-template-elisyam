...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Compact Dashboard (Dark Version)</title>
    ...
    <body id="page-top">
                ...
                <nav class="navbar fixed-top">         
                    ...
                    <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
                        ...
                        <div class="navbar-header">
                            <a href="db-compact.html" class="navbar-brand">
                                <div class="brand-image brand-big">
                                    <img src="assets/img/logo-2.png" alt="logo" style="width: 70px;" class="logo-big">
                                </div>
                ...
                <div class="compact-sidebar">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                            <li class="active"><a href="#dropdown-db" aria-expanded="true" data-toggle="collapse"><i class="la la-columns"></i></a>
                                <ul id="dropdown-db" class="collapse list-unstyled show pt-0">
                                    <li><a href="db-default-dark.html">Default</a></li>
                                    <li><a href="db-clean-dark.html">Clean</a></li>
                                    <li><a class="active" href="db-compact-dark.html">Compact</a></li>
        ...
        <!-- End Page Vendor Js -->
        <!-- Begin Page Snippets -->
        <script src="assets/js/dashboard/db-compact-dark.js"></script>
        <!-- End Page Snippets -->
    </body>
</html>