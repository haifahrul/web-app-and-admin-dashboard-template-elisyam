        ...
        <div class="page">
            ...
            <div class="page-content d-flex align-items-stretch">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="#dropdown-generic" aria-expanded="true" data-toggle="collapse"><i class="la la-file-text"></i><span>Generic</span></a>
                                <ul id="dropdown-generic" class="collapse list-unstyled show pt-0">
                                    ...
                                    <li><a class="active" href="pages-faq.html">FAQ</a></li>
                ...
                <div class="content-inner faq">
                    <!-- Begin Jumbotron -->
					<div class="jumbotron jumbotron-fluid d-flex justify-content-center align-items-center text-center">
					    <div class="container">
					        <h2>Help Center</h2>
							<div class="searchbox">
							    <input type="text" name="search" placeholder="Search in faq's ...">
							</div>
					    </div>
					</div>
                    <!-- End Jumbotron -->
