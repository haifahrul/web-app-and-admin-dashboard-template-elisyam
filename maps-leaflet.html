...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Maps Leaflet</title>
    ...
    <body id="page-top">
                ...
                <div class="default-sidebar">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="maps-leaflet.html"><i class="la la-map"></i><span>Maps</span></a></li>
                        </ul>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row flex-row">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Map With Custom Marker</h4>
                                    </div>
                                    <div class="widget-body">
                                        <div id="custom-marker" style="height: 400px;"></div>
                                    </div>
                                </div>
                                <!-- End Basic Custom Marker -->
                            </div>
                            <div class="col-xl-6">
        ...
        <!-- End Page Vendor Js -->
        <!-- Begin Page Snippets -->
        <script src="assets/js/components/leaflet/maps-leaflet.min.js"></script>
        <!-- End Page Snippets -->
    </body>
</html>