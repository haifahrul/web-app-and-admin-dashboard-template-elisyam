...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Search Results</title>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="#dropdown-generic" aria-expanded="true" data-toggle="collapse"><i class="la la-file-text"></i><span>Generic</span></a>
                                <ul id="dropdown-generic" class="collapse list-unstyled show pt-0">
                                    ...
                                    <li><a class="active" href="pages-search.html">Search</a></li>
                        ...
                        <div class="row">
                            <div class="page-header">
                                <div class="d-flex align-items-center">
                                    <h2 class="page-header-title">Search Results</h2>
                                    <div>
                                        <ul class="breadcrumb">
                            ...
                            <div class="col-xl-12">
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h2>84 Results Found</h2>
                                        <span>Results:  1 - 12 of 84</span>
                                    </div>
                                    <div class="widget-body">
                                        <div class="row d-flex align-items-center margin-top-10">
                                            <div class="col-md-6 search-items">
                                                <h4>
                                                    <a class="link-effect" href="#">Elisyam - Web App & Admin Dashboard Template</a>
                                                </h4>
                                                <div class="text-success">https://www.example.com</div>
                                                <p>
                                        ...
                                        <div class="row">
                                            <div class="col d-flex align-items-center margin-bottom-10">
                                                <nav aria-label="...">
                                                    <ul class="pagination">
                                                        <li class="page-item">
