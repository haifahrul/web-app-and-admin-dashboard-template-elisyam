                        ...
                        <ul class="list-unstyled">
                            <li class="active"><a href="#dropdown-ui" aria-expanded="true" data-toggle="collapse"><i class="la la-share-alt"></i><span>UI Elements</span></a>
                                <ul id="dropdown-ui" class="collapse list-unstyled show pt-0">
                                    ...
                                    <li><a class="active" href="components-alerts.html">Alerts</a></li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Alerts</h2>
	                                <div>
			                            <ul class="breadcrumb">
                            ...
                            <div class="col-xl-6">
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <!-- Bordered Style -->
                                        <div class="alert alert-outline-info dashed" role="alert">
                                        ...
                                        <div class="alert alert-outline-secondary" role="alert">
                                            <span class="text-gradient-03"><strong>Hey!</strong> This is an alert with text gradient</span>
                                        </div>
                                        ...
                                        <!-- Square Style -->
                                        <div class="alert alert-primary square" role="alert">
                                            <strong>Hey!</strong> This is a primary alert
                                        </div>
                                        <div class="alert alert-secondary square" role="alert">
                                            <strong>Hey!</strong> This is a secondary alert
                                        </div>
                                        ...
                                        <div class="alert alert-primary-bordered alert-lg square" role="alert">
                                            <strong>Hey!</strong> This is a primary alert
                                        </div>
                                        <div class="alert alert-info-bordered alert-lg square" role="alert">
                                            <strong>Hey!</strong> This is a danger alert
                                        </div>
                                        <!-- End Other Style -->
                                    </div>
