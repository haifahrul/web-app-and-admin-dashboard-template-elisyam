...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Components Popover</title>
                        ...
                        <ul class="list-unstyled">
                            <li class="active"><a href="#dropdown-ui" aria-expanded="true" data-toggle="collapse"><i class="la la-share-alt"></i><span>UI Elements</span></a>
                                <ul id="dropdown-ui" class="collapse list-unstyled show pt-0">
                                    ...
                                    <li><a class="active" href="components-popover.html">Popover</a></li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Popover</h2>
	                                <div>
			                            <ul class="breadcrumb">
                        ...
                        <div class="row flex-row">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="section-title mb-5">
                                            <h4>Basic Popovers</h4>
                                        </div>
                                        <button type="button" class="btn btn-primary" data-toggle="popover" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Click me
                                        </button>
                                        <div class="section-title mt-5 mb-5">
                                            <h4>Directions</h4>
                                        </div>
                                        <button type="button" class="btn btn-primary mr-2 mb-3" data-toggle="popover" data-placement="top" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Popover On Top
                                        </button>
                                        <button type="button" class="btn btn-info mr-2 mb-3" data-toggle="popover" data-placement="right" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Popover On Right
                                        </button>
                                        <button type="button" class="btn btn-success mr-2 mb-3" data-toggle="popover" data-placement="bottom" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Popover On Bottom
                                        </button>
                                        <button type="button" class="btn btn-warning mb-3" data-toggle="popover" data-placement="left" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Popover On Left
                                        </button>
                                        ...
                                        <button type="button" class="btn btn-danger" data-toggle="popover" data-trigger="focus" data-content="Now click somewhere else.">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="section-title mb-5">
                                            <h4>Popovers On Hover</h4>
                                        </div>
                                        <button type="button" class="btn btn-primary mr-2 mb-3" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Popover On Top
                                        </button>
                                        <button type="button" class="btn btn-info mr-2 mb-3" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Popover On Right
                                        </button>
                                        <button type="button" class="btn btn-success mr-2 mb-3" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Popover On Bottom
                                        </button>
                                        <button type="button" class="btn btn-warning mb-3" data-toggle="popover" data-trigger="hover" data-placement="left" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Popover On Left
                                        </button>
                                        <p>Use <code>data-trigger="hover"</code> for hover trigger.</p>
                                        <div class="section-title mt-5 mb-5">
                                            <h4>Popovers With Title</h4>
                                        </div>
                                        <button type="button" class="btn btn-primary mr-2 mb-3" data-toggle="popover" title="Popover Title" data-placement="top" data-content="Pellentesque sed ante id mauris varius imperdiet. Aenean laoreet nisi est, sit amet eleifend nulla semper non.">
                                          Click Me
                                        </button>
                                        <div class="section-title mt-5 mb-5">
                                            <h4>With HTML Content</h4>
                                        </div>
                                        <button type="button" class="btn btn-gradient-01 mr-2 mb-3" data-toggle="popover" data-original-title="This is <b>HTML</b> <u>Popover</u>" data-placement="top" data-content="<b>Pellentesque</b> sed ante id mauris varius imperdiet.<br><br>Aenean laoreet nisi est, sit amet <code>.eleifend</code> nulla semper non." data-html="true">
                                          HTML Popover
                                        </button>
                                    </div>
                                </div>
