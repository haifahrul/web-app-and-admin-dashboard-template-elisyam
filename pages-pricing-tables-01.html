...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Pricing Tables</title>
                ...
                <div class="default-sidebar">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="#dropdown-pricing" aria-expanded="true" data-toggle="collapse"><i class="la la-usd"></i><span>Pricing</span></a>
                                <ul id="dropdown-pricing" class="collapse list-unstyled show pt-0">
                                    <li><a class="active" href="pages-pricing-tables-01.html">Style 01</a></li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Pricing Tables 01</h2>
	                                <div>
			                            <ul class="breadcrumb">
			                                <li class="breadcrumb-item"><a href="db-default.html"><i class="ti ti-home"></i></a></li>
			                                <li class="breadcrumb-item"><a href="#">Pages</a></li>
			                                <li class="breadcrumb-item active">Pricing Tables 01</li>
			                            </ul>
	                                </div>
	                            </div>
                            </div>
                                                    ...
                                                    <div class="pricing-tables-02 pricing-wrapper">
                                                        <div class="inner-container">
                                                            ...
                                                            <div class="pricing-image">
                                                                <img src="assets/img/icone-01.png" alt="...">
                                                            </div>
                                                            <div class="pricing-list">
                                                                <ul>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>10 Accounts</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>50 GB Space</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>1 Domain Name</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>500 GB Bandwidth</li>
                                                                </ul>
                                                            </div>
                                                            <div class="main-number">$20<small>/mo</small></div>
                                                        </div>
                                                ...
                                                <div class="col-lg-4 no-padding">
                                                    <div class="pricing-tables-02 purple pricing-wrapper">
                                                        <div class="inner-container">
                                                            ...
                                                            <div class="pricing-image">
                                                                <img src="assets/img/icone-04-white.png" alt="...">
                                                            </div>
                                                            <div class="pricing-list">
                                                                <ul>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>50 Accounts</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>1000 GB Space</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>Unlimited Domain Name</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>5 TB Bandwidth</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>Premium Coffee</li>
                                                                </ul>
                                                            </div>
                                                            <div class="main-number">$95<small>/mo</small></div>
                                                        </div>
                                                        <a class="btn btn-lg btn-shadow" href="#">Purchase</a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 no-padding">
                                                    <div class="pricing-tables-02 dark pricing-wrapper">
                                                        <div class="inner-container">
                                                            ...
                                                            <div class="pricing-image">
                                                                <img src="assets/img/icone-03-white.png" alt="...">
                                                            </div>
                                                            <div class="pricing-list">
                                                                <ul>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>20 Accounts</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>500 GB Space</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>10 Domain Name</li>
                                                                    <li><i class="ion-checkmark margin-right-5"></i>1 TB Bandwidth</li>
                                                                </ul>
                                                            </div>
                                                            <div class="main-number">$65<small>/mo</small></div>
                                                        </div>
                                                        <a class="btn btn-lg btn-shadow" href="#">Purchase</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="pricing-tables-fixed">
                                            <div class="row">
                                                <div class="col-lg-4 no-padding">
                                                    <div class="pricing-tables-02 pricing-wrapper">
                                                        <div class="inner-container">
                                                            ...
                                                            <div class="pricing-list">
                                                                <p>
                                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris at aliquam dui, sed ullamcorper velit
                                                                </p>
                                                            </div>
                                                            <div class="main-number">$0</div>
                                                        </div>
                                                        <a class="btn btn-lg btn-shadow" href="#">Get it for free</a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 no-padding">
                                                    <div class="pricing-tables-02 pricing-wrapper">
                                                        <div class="inner-container">
                                                            <div class="title">Basic</div>
                                                            <div class="pricing-image">
                                                                <img src="assets/img/icone-03.png" alt="...">
                                                            </div>
                                                            <div class="pricing-list">
                                                                <p>
                                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris at aliquam dui, sed ullamcorper velit
                                                ...
                                                <div class="col-lg-4 no-padding">
                                                    <div class="pricing-tables-02 pricing-wrapper">
                                                        <div class="inner-container">
                                                            <div class="title text-gradient-01">Premium</div>
                                                            <div class="pricing-image">
                                                                <img src="assets/img/icone-04.png" alt="...">
                                                            </div>
                                                            <div class="pricing-list">
                                                                <p>
                                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris at aliquam dui, sed ullamcorper velit
                                                            ...
                                                            <div class="main-number">$95</div>
                                                        </div>
                                                        <a class="btn btn-lg btn-gradient-01" href="#">Purchase</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
