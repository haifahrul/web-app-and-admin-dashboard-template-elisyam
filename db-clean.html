...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Clean Dashboard</title>
    ...
    <body id="page-top">
                ...
                <div class="compact-light-sidebar has-shadow">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                            <li class="active"><a href="#dropdown-db" aria-expanded="false" data-toggle="collapse"><i class="la la-columns"></i></a>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="#dropdown-ui" aria-expanded="false" data-toggle="collapse"><i class="la la-share-alt"></i></a>
                            ...
                            <li><a href="#dropdown-icons" aria-expanded="false" data-toggle="collapse"><i class="la la-font"></i></a>
                            ...
                            <li><a href="#dropdown-forms" aria-expanded="false" data-toggle="collapse"><i class="la la-list-alt"></i></a>
                            ...
                            <li><a href="#dropdown-tables" aria-expanded="false" data-toggle="collapse"><i class="la la-th-large"></i><span></span></a>
                            ...
                            <li><a href="maps-leaflet.html"><i class="la la-map"></i></a></li>
                        </ul>
                        <span class="sidebar-separator"></span>
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#dropdown-generic" aria-expanded="false" data-toggle="collapse"><i class="la la-file-text"></i></a>
                            ...
                            <li><a href="#dropdown-social" aria-expanded="false" data-toggle="collapse"><i class="la la-comments"></i></a>
                            ...
                            <li><a href="#dropdown-email" aria-expanded="false" data-toggle="collapse"><i class="la la-at"></i></a>
                            ...
                            <li><a href="#dropdown-pricing" aria-expanded="false" data-toggle="collapse"><i class="la la-usd"></i></a>
                            ...
                            <li><a href="#dropdown-error" aria-expanded="false" data-toggle="collapse"><i class="la la-exclamation-triangle"></i></a>
                ...
                <div class="content-inner compact">
                    <div class="container-fluid">
                            ...
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                ...
	                                <div class="page-header-tools">
	                                    <a class="btn btn-outline-primary" href="#">Add Widget</a>
	                                </div>
	                                </div>
	                            </div>
                            </div>
                        ...
                        <div class="row flex-row">
                                    	...
                                    	<div class="row">
                                    		<div class="col-12 d-flex align-items-center">
		                                        ...
		                                        <div class="star-rating">
			                                        <ul>
			                                        	<li><i class="la la-star rate"></i></li>
			                                        	<li><i class="la la-star rate"></i></li>
			                                        	<li><i class="la la-star rate"></i></li>
			                                        	<li><i class="la la-star rate"></i></li>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <!-- Begin Widget 35 -->
                                <div class="widget-35 widget has-shadow">
                                	<div class="widget-body h-100">
                                		<div class="row align-items-center">
                                			<div class="col-xl-6 d-flex align-items-center">
			                                    ...
			                                    <div class="user-n">
		                                            <div class="m-name">Nathan hunter</div>
		                                            <div class="account-name">@nhunter</div>
			                                    </div>
			                                </div>
			                            ...
			                            <div class="w-text">
                                            <div class="widget35 owl-carousel">
                                                <div class="item">
                        ...
                        <div class="row flex-row">
                            ...
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="widget-39 widget d-flex align-items-center justify-content-center bg-dark has-shadow">
                                	<div class="widget-effect"><i class="ti ti-unlock"></i></div>
                                    <!-- Begin Widget Body -->
                                    <div class="widget-body text-center">
                                    	<i class="ti ti-crown mb-3 text-gradient-01"></i>
                                         <div class="congrats-name mb-2">Congratulations!</div>
                                         <p>You have unlocked a new badge</p>
                                         <a class="btn btn-gradient-01 mt-3" href="#">It's Awesome</a>
                                    </div>
                                    <!-- End Widget Body -->
                                </div>
                                <!-- End Widget 11 -->
                            ...
                            <div class="col-xl-5">
                                <!-- Leaflet -->
                                <div class="widget widget-38 has-shadow">
        ...
        <!-- End Page Vendor Js -->
        <!-- Begin Page Snippets -->
        <script src="assets/js/dashboard/db-clean.min.js"></script>
        <!-- End Page Snippets -->
    </body>
</html>