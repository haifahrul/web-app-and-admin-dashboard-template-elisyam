...
<html lang="en">
<head>
<title>Elisyam | Reset Password</title>
<meta charset="utf-8">
...
<body style="margin: 0; padding: 0;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
        <tr>
            <td bgcolor="#5d5386" align="center">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                            <tr>
                                                <td align="left" style="font-size: 35px; font-family: Montserrat, Arial, sans-serif; color: #2c304d; padding: 30px 15px 0 15px;" class="padding-copy">Hi David,</td>
                                            </tr>
                                            <tr>
                                                <td align="left" style="padding: 20px 15px 0 15px; font-size: 15px; line-height: 25px; font-family: Noto Sans, Arial, sans-serif; color: #aea9c3;" class="padding-copy">We've received a request to reset your password.<br>You can reset your password using this link:</td>
                                            </tr>
                                        </table>
                                        <!-- End Content -->
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                            <tr>
                                                <td align="left" style="padding: 20px 15px 0 15px; font-size: 15px; line-height: 25px; font-family: Noto Sans, Arial, sans-serif; color: #aea9c3;" class="padding-copy">If you didn't make the request, just ignore this email.<br><br>Thanks!<br>The Elisyam Team</td>
                                            </tr>
                                        </table>
                                        <!-- End Content -->
                                    </td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                <tr>
                                    <td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="left" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #2c304d; padding: 50px 15px 0 15px;" class="padding-copy">Questions?</td>
                                            </tr>
                                            <tr>
                                                <td align="left" style="padding: 20px 15px 35px 15px; font-size: 15px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #aea9c3;" class="padding-copy">If you have any questions you can simply reply to this email or find our contact information below. Also contact us at <a class="original-only" style="color: #5d5386; text-decoration: underline;" href="#">contact@example.com</a></td>
                                            </tr>
                                        </table>
                                        <!-- End Content -->
                                    </td>
                            ...
                            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                                <tr>
                                    <td align="center" valign="middle" style="font-size: 12px; line-height: 24px; font-family: Noto Sans, Arial, sans-serif; color:#aea9c3; padding-bottom: 35px;" bgcolor="#ffffff">
                                        <a href="#">
                                            <img src="assets/img/email/ico-facebook.png" alt="..." width="40" height="40" style="display: inline-block;" border="0">
                                        </a>
                                        <span class="original-only" style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        <a href="#">
                                            <img src="assets/img/email/ico-twitter.png" alt="..." width="40" height="40" style="display: inline-block;" border="0">
                                        </a>
                                        <span class="original-only" style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        <a href="#">
                                            <img src="assets/img/email/ico-linkedin.png" alt="..." width="40" height="40" style="display: inline-block;" border="0">
                                        </a>
                                    </td>
                                </tr>
                            </table>
