                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="#dropdown-pricing" aria-expanded="true" data-toggle="collapse"><i class="la la-usd"></i><span>Pricing</span></a>
                                <ul id="dropdown-pricing" class="collapse list-unstyled show pt-0">
                                    ...
                                    <li><a class="active" href="pages-pricing-tables-02.html">Style 02</a></li>
                                </ul>
                            </li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Pricing Tables 02</h2>
	                                <div>
	                                    <ul class="breadcrumb">
	                                        <li class="breadcrumb-item"><a href="db-default.html"><i class="ti ti-home"></i></a></li>
	                                        <li class="breadcrumb-item"><a href="#">Pages</a></li>                                        
	                                        <li class="breadcrumb-item active">Pricing Tables 02</li>
	                                    </ul>
	                                </div>
	                            </div>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 no-padding">
                                                    <div class="pricing-tables-01 pricing-wrapper">
                                                        <div class="inner-container">
                                                            ...
                                                            <div class="container-text">20 gb</div>
                                                            <div class="main-number">20</div>
                                                            <div class="pricing-list">
                                                                <p>
                                                                    Etiam viverra neque vel metus eleifend dapibus id nec eros. Ut ac mi efficitur dui mattis finibus eu eu leo. Proin a ultrices elit. Aenean hendrerit luctus velit.
                                                                </p>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-4 no-padding">
                                                    <div class="pricing-tables-01 pricing-wrapper">
                                                        <div class="inner-container">
                                                            <div class="pricing-image">
                                                                <img src="assets/img/icone-02.png" alt="...">
                                                            </div>
                                                            <div class="title">Basic</div>
                                                            <div class="container-text">50 gb</div>
                                                ...
                                                <div class="col-lg-4 no-padding">
                                                    <div class="pricing-tables-01 pricing-wrapper last">
                                                        <div class="inner-container">
                                                            <div class="pricing-image">
                                                                <img src="assets/img/icone-04.png" alt="...">
                                                            </div>
                                                            <div class="title">Premium</div>
                                                            <div class="container-text">100 gb</div>
                                            ...
                                            <div class="col-lg-3 no-padding">
                                                <div class="pricing-tables-01 pricing-wrapper">
                                                    <div class="inner-container">
                                                        ...
                                                        <div class="container-text">10 gb</div>
                                                    ...
                                                    <a class="btn btn-lg btn-primary" href="#">Get it for free</a>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 no-padding">
                                                <div class="pricing-tables-01 pricing-wrapper">
                                            ...
                                            <div class="col-lg-3 no-padding">
                                                <div class="pricing-tables-01 pricing-wrapper">
                                                    <div class="inner-container">
                                                        ...
                                                        <div class="title">Basic</div>
                                                        <div class="container-text">80 gb</div>
                                                        <div class="main-number">80</div>
                                                        <div class="pricing-list">
                                                            <p>
                                                                Etiam viverra neque vel metus eleifend dapibus id nec eros. Ut ac mi efficitur dui mattis finibus eu eu leo. Proin a ultrices elit. Aenean hendrerit luctus velit.
                                                            </p>
