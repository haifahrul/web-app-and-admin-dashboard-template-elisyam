...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Bootstrap Select</title>
                ...
                <div class="default-sidebar">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="#dropdown-forms" aria-expanded="true" data-toggle="collapse"><i class="la la-list-alt"></i><span>Forms</span></a>
                                <ul id="dropdown-forms" class="collapse list-unstyled show pt-0">
                                    <li><a href="forms-basic.html">Form Basic</a></li>
                                    <li><a href="forms-validation.html">Form Validation</a></li>
                                    <li><a href="forms-wizard.html">Form Wizard</a></li>
                                    <li><a class="active" href="forms-select.html">Bootstrap Select</a></li>
                                </ul>
                            </li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Bootstrap Select</h2>
	                                <div>
			                            <ul class="breadcrumb">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Standard</label>
                                                <div class="col-lg-7">
                                            ...
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Select with optgroups</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow">
                                            ...
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Multiple select</label>
                                                <div class="col-lg-7">
                                        ...
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                ...
                                                <div class="col-lg-7">
                                                    ...
                                                    <small class="d-block mt-2">Add <code>data-live-search="true"</code> attribute</small>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Keywords</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" data-live-search="true">
                                                    ...
                                                    <small class="d-block mt-2">Add <code>data-tokens</code> attribute</small>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="section-title mt-5 mb-5">
                                            <h4>Limit Selections</h4>
                                        </div>
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Standard</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" multiple data-max-options="2">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                                    </select>
                                                    <small class="d-block mt-2">Add <code>data-max-options</code> attribute</small>
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Select with optgroups</label>
                                        ...
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Standard</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" title="Hello :)">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                                    </select>
                                            ...
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Selected text</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" title="How are you?">
                                        ...
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                ...
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" multiple data-selected-text-format="count">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                                    </select>
                            ...
                            <div class="col-xl-6">
                                <div class="widget has-shadow">
                                    <div class="widget-body">
                                        ...
                                        <p class="text-dark">You can set the button classes via the <code>data-style attribute</code></p>
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-5 mb-3">
                                                <label class="col-lg-5 form-control-label">Primary</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" data-style="btn-primary">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                                    </select>
                                            ...
                                            <div class="form-group row d-flex align-items-center mt-3 mb-3">
                                                <label class="col-lg-5 form-control-label">Info</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" data-style="btn-info">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                                    </select>
                                            ...
                                            <div class="form-group row d-flex align-items-center mt-3 mb-3">
                                                <label class="col-lg-5 form-control-label">Success</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" data-style="btn-success">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                                    </select>
                                            ...
                                            <div class="form-group row d-flex align-items-center mt-3 mb-3">
                                                <label class="col-lg-5 form-control-label">Warning</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" data-style="btn-warning">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                                    </select>
                                            ...
                                            <div class="form-group row d-flex align-items-center mt-3 mb-3">
                                                <label class="col-lg-5 form-control-label">Danger</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" data-style="btn-danger">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                                    </select>
                                            ...
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Gradient</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow" data-style="btn-gradient-01">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                                    </select>
                                        ...
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                ...
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow">
                                                        <option data-icon="ion-bonfire">Camping</option>
                                                        <option data-icon="ion-beer">Beer</option>
                                                        <option data-icon="ion-radio-waves">Music</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="section-title mt-3 mb-5">
                                            <h4>Checkmark on Selected Option</h4>
                                        </div>
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Example</label>
                                        ...
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Example</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow show-tick" data-show-subtext="true" data-size="5">
                                        ...
                                        <form class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mt-3 mb-5">
                                                <label class="col-lg-5 form-control-label">Example</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker show-menu-arrow show-tick" multiple data-actions-box="true">
                                                        <option>Mustard</option>
                                                        <option>Ketchup</option>
                                                        <option>Relish</option>
                                        ...
                                        <p>Discover more awesome features 
                                            <a href="https://developer.snapappointments.com/bootstrap-select/">Here</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
