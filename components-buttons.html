...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Components Buttons</title>
                        ...
                        <ul class="list-unstyled">
                            <li class="active"><a href="#dropdown-ui" aria-expanded="true" data-toggle="collapse"><i class="la la-share-alt"></i><span>UI Elements</span></a>
                                <ul id="dropdown-ui" class="collapse list-unstyled show pt-0">
                                    <li><a class="active" href="components-buttons.html">Buttons</a></li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Buttons</h2>
	                                <div>
			                            <ul class="breadcrumb">
                        ...
                        <div class="row flex-row">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary mr-1 mb-2">Primary</button>
                                            <button type="button" class="btn btn-secondary mr-1 mb-2">Secondary</button>
                                            <button type="button" class="btn btn-success mr-1 mb-2">Success</button>
                                            <button type="button" class="btn btn-info mr-1 mb-2">Info</button>
                                            <button type="button" class="btn btn-warning mr-1 mb-2">Warning</button>
                                            <button type="button" class="btn btn-danger mr-1 mb-2">Danger</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Basic Buttons -->
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary ripple mr-1 mb-2">Primary</button>
                                            <button type="button" class="btn btn-secondary ripple mr-1 mb-2">Secondary</button>
                                            <button type="button" class="btn btn-success ripple mr-1 mb-2">Success</button>
                                            <button type="button" class="btn btn-info ripple mr-1 mb-2">Info</button>
                                            <button type="button" class="btn btn-warning ripple mr-1 mb-2">Warning</button>
                                            <button type="button" class="btn btn-danger ripple mr-1 mb-2">Danger</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Basic Buttons -->
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-outline-primary mr-1 mb-2">Primary</button>
                                            <button type="button" class="btn btn-outline-secondary mr-1 mb-2">Secondary</button>
                                            <button type="button" class="btn btn-outline-success mr-1 mb-2">Success</button>
                                            <button type="button" class="btn btn-outline-info mr-1 mb-2">Info</button>
                                            <button type="button" class="btn btn-outline-warning mr-1 mb-2">Warning</button>
                                            <button type="button" class="btn btn-outline-danger mr-1 mb-2">Danger</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Outline Buttons -->
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Elisyam Buttons</h4>
                                    </div>
                                    <div class="widget-body">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-shadow mr-1 mb-2">Shadow</button>
                                            <button type="button" class="btn btn-gradient-01 mr-1 mb-2">Gradient 01</button>
                                            <button type="button" class="btn btn-gradient-02 mr-1 mb-2">Gradient 02</button>
                                            <button type="button" class="btn btn-gradient-03 mr-1 mb-2">Gradient 03</button>
                                            <button type="button" class="btn btn-gradient-04 mr-1 mb-2">Gradient 04</button>
                                            <button type="button" class="btn btn-gradient-05 mr-1 mb-2">Gradient 05</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Elisyam Buttons -->
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary btn-square mr-1 mb-2">Primary</button>
                                            <button type="button" class="btn btn-secondary btn-square mr-1 mb-2">Secondary</button>
                                            <button type="button" class="btn btn-success btn-square mr-1 mb-2">Success</button>
                                            <button type="button" class="btn btn-info btn-square mr-1 mb-2">Info</button>
                                            <button type="button" class="btn btn-warning btn-square mr-1 mb-2">Warning</button>
                                            <button type="button" class="btn btn-danger btn-square mr-1 mb-2">Danger</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Square Buttons -->
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary mr-1 mb-2"><i class="la la-pencil"></i>Primary</button>
                                            <button type="button" class="btn btn-secondary mr-1 mb-2"><i class="la la-rocket"></i>Secondary</button>
                                            <button type="button" class="btn btn-success mr-1 mb-2"><i class="la la-check"></i>Success</button>
                                            <button type="button" class="btn btn-info mr-1 mb-2"><i class="la la-question-circle"></i>Info</button>
                                            <button type="button" class="btn btn-warning mr-1 mb-2"><i class="la la-exclamation-triangle"></i>Warning</button>
                                            <button type="button" class="btn btn-danger mr-1 mb-2"><i class="la la-ban"></i>Danger</button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="form-group">
                                            ...
                                            <div class="btn-group mr-1 mb-2">
                                                ...
                                                <a class="btn btn-success dropdown-toggle d-flex align-items-center" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="la la-angle-down mr-0"></i>
                                                </a>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#">Action</a>
                                            ...
                                            <div class="btn-group mr-1 mb-2">
                                                ...
                                                <a class="btn btn-info dropdown-toggle d-flex align-items-center" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="la la-angle-down mr-0"></i>
                                                </a>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#">Action</a>
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <button type="button" class="btn btn-shadow btn-block mb-2">Shadow</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <button type="button" class="btn btn-primary btn-lg mr-1 mb-2">Large Button</button>
                                        <button type="button" class="btn btn-success mr-1 mb-2">Medium Button</button>
                                        <button type="button" class="btn btn-warning btn-sm mr-1 mb-2">Small Button</button>
                                    </div>
                                </div>
                                <!-- End Buttons Sizes -->
                            </div>
