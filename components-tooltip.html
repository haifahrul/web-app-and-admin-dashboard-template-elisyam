                        ...
                        <ul class="list-unstyled">
                            <li class="active"><a href="#dropdown-ui" aria-expanded="true" data-toggle="collapse"><i class="la la-share-alt"></i><span>UI Elements</span></a>
                                <ul id="dropdown-ui" class="collapse list-unstyled show pt-0">
                                    ...
                                    <li><a class="active" href="components-tooltip.html">Tooltip</a></li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Tooltip</h2>
	                                <div>
			                            <ul class="breadcrumb">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Tooltip Title">
                                          Click Me
                                        </button>
                                        <div class="section-title mt-5 mb-5">
                                            <h4>Directions</h4>
                                        </div>
                                        <button type="button" class="btn btn-primary mr-2 mb-3" data-toggle="tooltip" data-placement="top" title="Tooltip Top">
                                          Tooltip On Top
                                        </button>
                                        <button type="button" class="btn btn-info mr-2 mb-3" data-toggle="tooltip" data-placement="right" title="Tooltip Right">
                                          Tooltip On Right
                                        </button>
                                        <button type="button" class="btn btn-success mr-2 mb-3" data-toggle="tooltip" data-placement="bottom" title="Tooltip Bottom">
                                          Tooltip On Bottom
                                        </button>
                                        <button type="button" class="btn btn-warning mb-3" data-toggle="tooltip" data-placement="left" title="Tooltip Left">
                                          Tooltip On Left
                                        </button>
                                        ...
                                        <button type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" data-trigger="focus" title="Now click anywhere">
                                          Dissmissible Tooltip
                                        </button>
                                    </div>
                                </div>
                                <!-- End Basic Example -->
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <button type="button" class="btn btn-primary mr-2 mb-3" data-toggle="tooltip" data-placement="top" data-trigger="click" title="Tooltip Title">
                                          Tooltip Top
                                        </button>
                                        <button type="button" class="btn btn-info mr-2 mb-3" data-toggle="tooltip" data-placement="right" data-trigger="click" title="Tooltip Title">
                                          Tooltip Right
                                        </button>
                                        <button type="button" class="btn btn-success mr-2 mb-3" data-toggle="tooltip" data-placement="bottom" data-trigger="click" title="Tooltip Title">
                                          Tooltip Bottom
                                        </button>
                                        <button type="button" class="btn btn-warning mb-3" data-toggle="tooltip" data-placement="left" data-trigger="click" title="Tooltip Title">
                                          Tooltip Left
                                        </button>
                                        ...
                                        <button type="button" class="btn btn-danger mr-2 mb-3" data-toggle="tooltip" data-placement="top" data-trigger="click" title="Tooltip Title" data-delay="800">
                                          Click Me
                                        </button>
                                        ...
                                        <button type="button" class="btn btn-gradient-01 mb-3" data-toggle="tooltip" data-placement="top" data-original-title="This is <b>HTML</b> <u>tooltip</u>" data-html="true">
                                          HTML Tooltip
                                        </button>
                                    </div>
                                </div>
