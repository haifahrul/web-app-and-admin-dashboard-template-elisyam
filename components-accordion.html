...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Components Accordion</title>
                        ...
                        <ul class="list-unstyled">
                            <li class="active"><a href="#dropdown-ui" aria-expanded="true" data-toggle="collapse"><i class="la la-share-alt"></i><span>UI Elements</span></a>
                                <ul id="dropdown-ui" class="collapse list-unstyled show pt-0">
                                    ...
                                    <li><a class="active" href="components-accordion.html">Accordion</a></li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Accordion</h2>
	                                <div>
			                            <ul class="breadcrumb">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div id="accordion-right" class="accordion">
                                    ...
                                    <div class="widget has-shadow">
                                        <div class="widget-header bordered no-actions d-flex align-items-center">
                                            <h2>Accordion Right Aligned</h2>
                                        </div>
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#RightcollapseOne">
                                            <div class="card-title text-right w-100">Lorem ipsum dolor sit amet?</div>
                                        </a>
                                        <div id="RightcollapseOne" class="card-body collapse show pt-0 text-right" data-parent="#accordion-right">
                                            <p>
                                                Praesent nibh nulla, vehicula vitae metus nec, lobortis commodo lorem. Nulla pulvinar vestibulum semper. Curabitur tempor, orci eget laoreet lacinia, urna orci facilisis massa, nec convallis arcu lacus eu mi. Aliquam semper ante eget venenatis pellentesque. Sed suscipit sem id ligula sollicitudin pulvinar. Donec porta enim nec dignissim commodo. Mauris ac elit diam. In vel mattis massa. Donec id mi blandit diam fringilla fringilla vitae id elit.  
                                            </p>
                                        </div>
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#RightcollapseTwo">
                                            <div class="card-title text-right w-100">Nam fermentum mauris at lacus?</div>
                                        </a>
                                        <div id="RightcollapseTwo" class="card-body collapse pt-0 text-right" data-parent="#accordion-right">
                                            <p>
                                                Etiam ut eleifend eros. Morbi in lectus ut nulla dapibus ornare. Praesent et sapien ac tortor consectetur bibendum.Nam nec sem at lacus tempor porta. Donec ultricies ante sed urna cursus, eget vestibulum libero congue
                                            </p>
                                        </div>
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#RightcollapseThree">
                                            <div class="card-title text-right w-100">Aenean feugiat interdum iaculis?</div>
                                        </a>
                                        <div id="RightcollapseThree" class="card-body collapse pt-0 text-right" data-parent="#accordion-right">
                                            <p>
                                                Etiam ut eleifend eros. Morbi in lectus ut nulla dapibus ornare. Praesent et sapien ac tortor consectetur bibendum.Nam nec sem at lacus tempor porta. Donec ultricies ante sed urna cursus, eget vestibulum libero congue. Praesent nibh nulla, vehicula vitae metus nec, lobortis commodo lorem. Nulla pulvinar vestibulum semper
                                            </p>
                                        </div>
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#RightcollapseFour">
                                            <div class="card-title text-right w-100">Curabitur eget lacinia ligula vivamus?</div>
                                        </a>
                                        <div id="RightcollapseFour" class="card-body collapse pt-0 text-right" data-parent="#accordion-right">
                                            <p>
                                                Nunc augue neque, congue a auctor at, tincidunt vel nulla. Phasellus justo urna, laoreet sit amet commodo sed, volutpat vitae eros. Praesent eu tristique diam, eu elementum ligula. Sed ac lectus non neque tristique elementum a et nisi. Donec pellentesque volutpat nisl, id commodo lacus posuere eget. 
                                            </p>
                                        </div>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div id="accordion-icon-left" class="accordion-icon icon-01">
                                    ...
                                    <div class="widget has-shadow">
                                        ...
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#IconLeftCollapseTwo">
                                            <div class="card-title">Nam fermentum mauris at lacus?</div>
                                        </a>
                                        <div id="IconLeftCollapseTwo" class="card-body collapse pt-0" data-parent="#accordion-icon-left">
                                            <p>
                                                Etiam ut eleifend eros. Morbi in lectus ut nulla dapibus ornare. Praesent et sapien ac tortor consectetur bibendum.Nam nec sem at lacus tempor porta. Donec ultricies ante sed urna cursus, eget vestibulum libero congue
                                            </p>
                                        </div>
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#IconLeftCollapseThree">
                                            <div class="card-title">Aenean feugiat interdum iaculis?</div>
                                        </a>
                                        <div id="IconLeftCollapseThree" class="card-body collapse pt-0" data-parent="#accordion-icon-left">
                                            <p>
                                                Etiam ut eleifend eros. Morbi in lectus ut nulla dapibus ornare. Praesent et sapien ac tortor consectetur bibendum.Nam nec sem at lacus tempor porta. Donec ultricies ante sed urna cursus, eget vestibulum libero congue. Praesent nibh nulla, vehicula vitae metus nec, lobortis commodo lorem. Nulla pulvinar vestibulum semper
                                            </p>
                                        </div>
                            ...
                            <div class="col-xl-6">
                                <!-- Begin Icons 02 -->
                                <div id="accordion-icon-right" class="accordion-icon icon-02">
                                    <!-- Begin Widget -->
                                    <div class="widget has-shadow">
                                        <div class="widget-header bordered no-actions d-flex align-items-center">
                                            <h2>Accordion Icons 02</h2>
                                        </div>
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#IconRightCollapseOne">
                                            <div class="card-title w-100">Lorem ipsum dolor sit amet?</div>
                                        </a>
                                        <div id="IconRightCollapseOne" class="card-body collapse pt-0" data-parent="#accordion-icon-right">
                                            <p>
                                                Praesent nibh nulla, vehicula vitae metus nec, lobortis commodo lorem. Nulla pulvinar vestibulum semper. Curabitur tempor, orci eget laoreet lacinia, urna orci facilisis massa, nec convallis arcu lacus eu mi. Aliquam semper ante eget venenatis pellentesque. Sed suscipit sem id ligula sollicitudin pulvinar. Donec porta enim nec dignissim commodo. Mauris ac elit diam. In vel mattis massa. Donec id mi blandit diam fringilla fringilla vitae id elit.  
                                            </p>
                                        </div>
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#IconRightCollapseTwo">
                                            <div class="card-title w-100">Nam fermentum mauris at lacus?</div>
                                        </a>
                                        <div id="IconRightCollapseTwo" class="card-body collapse pt-0" data-parent="#accordion-icon-right">
                                            <p>
                                                Etiam ut eleifend eros. Morbi in lectus ut nulla dapibus ornare. Praesent et sapien ac tortor consectetur bibendum.Nam nec sem at lacus tempor porta. Donec ultricies ante sed urna cursus, eget vestibulum libero congue
                                            </p>
                                        </div>
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#IconRightCollapseThree">
                                            <div class="card-title w-100">Aenean feugiat interdum iaculis?</div>
                                        </a>
                                        <div id="IconRightCollapseThree" class="card-body collapse pt-0" data-parent="#accordion-icon-right">
                                            <p>
                                                Etiam ut eleifend eros. Morbi in lectus ut nulla dapibus ornare. Praesent et sapien ac tortor consectetur bibendum.Nam nec sem at lacus tempor porta. Donec ultricies ante sed urna cursus, eget vestibulum libero congue. Praesent nibh nulla, vehicula vitae metus nec, lobortis commodo lorem. Nulla pulvinar vestibulum semper
                                            </p>
                                        </div>
                                        <a class="card-header collapsed d-flex align-items-center" data-toggle="collapse" href="#IconRightCollapseFour">
                                            <div class="card-title w-100">Curabitur eget lacinia ligula vivamus?</div>
                                        </a>
                                        <div id="IconRightCollapseFour" class="card-body collapse pt-0" data-parent="#accordion-icon-right">
                                            <p>
                                                Nunc augue neque, congue a auctor at, tincidunt vel nulla. Phasellus justo urna, laoreet sit amet commodo sed, volutpat vitae eros. Praesent eu tristique diam, eu elementum ligula. Sed ac lectus non neque tristique elementum a et nisi. Donec pellentesque volutpat nisl, id commodo lacus posuere eget. 
                                            </p>
                                        </div>
