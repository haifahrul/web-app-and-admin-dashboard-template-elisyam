                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 d-flex align-items-center mb-3">
                                                <p class="text-dark mb-0">Modal Scrolling Long Content</p>
                                            </div>
                                            <div class="col-xl-8 d-flex align-items-center mb-3">
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#scroll-modal">Launch Modal</button>
                                            </div>
                                        </div>
                                        <!-- End Scrolling Modal -->
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 d-flex align-items-center mb-3">
                                                <p class="text-dark mb-0">Vertically Centered</p>
                                            </div>
                                            <div class="col-xl-8 d-flex align-items-center mb-3">
                                                <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#modal-centered">Launch Modal</button>
                                            </div>
                                        </div>
                                        <!-- End Centered Modal -->
                                        <!-- Begin Small Modal -->
                                        <div class="row">
                                            <div class="col-xl-4 d-flex align-items-center mb-3">
                                                <p class="text-dark mb-0">Small Modal</p>
                                            </div>
                                            <div class="col-xl-8 d-flex align-items-center mb-3">
                                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-small">Launch Modal</button>
                                            </div>
                                        </div>
                                        <!-- End Small Modal -->
                                        <!-- Begin Large Modal -->
