                        ...
                        <ul class="list-unstyled">
                            <li class="active"><a href="#dropdown-db" aria-expanded="true" data-toggle="collapse"><i class="la la-columns"></i><span>Dashboard</span></a>
                                <ul id="dropdown-db" class="collapse list-unstyled show pt-0">
                                    ...
                                    <li><a class="active" href="db-all.html">All</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="col-xl-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 d-flex justify-content-center">
                                        <div class="widget has-shadow">
                                            <div class="widget-header no-actions mt-3">
                                                <h2 class="d-block text-center">Smarthome</h2>
                                            </div>
                                            <div class="text-center">
                                                <a class="btn btn-shadow mb-5" href="db-smarthome-dark.html">View Demo</a>
                                            </div>
                                            <a href="db-smarthome-dark.html">
                                                <img src="assets/img/dashboards/db-smarthome-dark.jpg" class="img-fluid pr-4 pl-4" alt="default">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Default -->
                                    ...
                                    <div class="col-xl-6 d-flex justify-content-center">
                                        <div class="widget has-shadow">
                                            <div class="widget-header no-actions mt-3">
                                                <h2 class="d-block text-center">Default</h2>
                                            </div>
                                            <div class="text-center">
                                                <a class="btn btn-shadow mb-5" href="db-default-dark.html">View Demo</a>
                                            </div>
                                            <a href="db-default-dark.html">
                                                <img src="assets/img/dashboards/db-default-dark.jpg" class="img-fluid pr-4 pl-4" alt="default">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Default -->
                                    ...
                                    <div class="col-xl-6 d-flex justify-content-center">
                                        <div class="widget has-shadow">
                                            <div class="widget-header no-actions mt-3">
                                                <h2 class="d-block text-center">Compact</h2>
                                            </div>
                                            <div class="text-center">
                                                <a class="btn btn-shadow mb-5" href="db-compact-dark.html">View Demo</a>
                                            </div>
                                            <a href="db-compact-dark.html">
                                                <img src="assets/img/dashboards/db-compact-dark.jpg" class="img-fluid pr-4 pl-4" alt="compact">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Compact -->
                                    ...
                                    <div class="col-xl-6 d-flex justify-content-center">
                                        <div class="widget has-shadow">
                                            <div class="widget-header no-actions mt-3">
                                                <h2 class="d-block text-center">Modern</h2>
                                            </div>
                                            <div class="text-center">
                                                <a class="btn btn-shadow mb-5" href="db-modern-dark.html">View Demo</a>
                                            </div>
                                            <a href="db-modern-dark.html">
                                                <img src="assets/img/dashboards/db-modern-dark.jpg" class="img-fluid pr-4 pl-4" alt="modern">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Modern -->
                                    ...
                                    <div class="col-xl-6 d-flex justify-content-center">
                                        <div class="widget has-shadow">
                                            <div class="widget-header no-actions mt-3">
                                                <h2 class="d-block text-center">Social</h2>
                                            </div>
                                            <div class="text-center">
                                                <a class="btn btn-shadow mb-5" href="db-social-dark.html">View Demo</a>
                                            </div>
                                            <a href="db-social-dark.html">
                                                <img src="assets/img/dashboards/db-social-dark.jpg" class="img-fluid pr-4 pl-4" alt="social">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- End Social -->
