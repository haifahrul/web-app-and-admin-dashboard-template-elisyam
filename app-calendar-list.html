...
<html lang="en">
    <head>
        ...
        <title>Elisyam - Calendar List View</title>
    ...
    <body id="page-top">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="#dropdown-app" aria-expanded="true" data-toggle="collapse"><i class="la la-puzzle-piece"></i><span>Applications</span></a>
                                <ul id="dropdown-app" class="collapse list-unstyled show pt-0">
                                    <li><a class="active" href="app-calendar.html">Calendar</a></li>
                        ...
                        <div class="row">
                            <div class="page-header">
                                <div class="d-flex align-items-center">
                                    <h2 class="page-header-title">Calendar List</h2>
                                    <div>
                                        <ul class="breadcrumb">
        ...
        <!-- End Page Vendor Js -->
        <!-- Begin Page Snippets -->
        <script src="assets/js/app/calendar/list-calendar.min.js"></script>
        <!-- End Page Snippets -->
    </body>
</html>