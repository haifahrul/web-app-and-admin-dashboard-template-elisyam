...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <div class="default-sidebar">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="active"><a href="#dropdown-tables" aria-expanded="true" data-toggle="collapse"><i class="la la-th-large"></i><span>Tables</span></a>
                                <ul id="dropdown-tables" class="collapse list-unstyled show pt-0">
                                    ...
                                    <li><a class="active" href="tables-tabledit.html">Tabledit</a></li>
                                </ul>
                            </li>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Tabledit</h2>
	                                <div>
			                            <ul class="breadcrumb">
			                                <li class="breadcrumb-item"><a href="db-default.html"><i class="ti ti-home"></i></a></li>
			                                <li class="breadcrumb-item active">Tabledit</li>
			                            </ul>
	                                </div>
	                            </div>
                            </div>
        ...
        <script src="assets/vendors/js/tabledit/jquery.tabledit.min.js"></script>
        <script src="assets/vendors/js/nicescroll/nicescroll.min.js"></script>
        <script src="assets/vendors/js/app/app.min.js"></script>
        <!-- End Page Vendor Js -->
        <!-- Begin Page Snippets -->
        <script src="assets/js/components/tabledit/tabledit.js"></script>
        <!-- End Page Snippets -->
    </body>
</html>